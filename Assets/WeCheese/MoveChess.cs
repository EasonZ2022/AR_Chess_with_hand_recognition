...
public class MoveChess : MonoBehaviour
{
    ...
    public GameObject sample_chess;
    ...
    public void chessUp()
    {
        sample_chess.transform.Translate(Vector3.forward * 0.05f, Space.Self);
    }

    public void chessDown()
    {
        sample_chess.transform.Translate(Vector3.back * 0.05f, Space.Self);
    }

    public void chessRight()
    {
        sample_chess.transform.Translate(Vector3.right * 0.05f, Space.Self);
    }

    public void chessLeft()
    {
        sample_chess.transform.Translate(Vector3.left * 0.05f, Space.Self);
    }
